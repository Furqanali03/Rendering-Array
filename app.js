...
// function clickme() {
//     let i = 0;
//     let ourProducts = document.getElementById("ourproducts"); // Moved inside the function to avoid global variable
...
//         `;
//         ourProducts.appendChild(productDiv);
//         i++;
//     }

// }

const ourProduct = document.querySelector("#ourproducts");
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <p class="card-text mb-3">${products[i].description}</p>
                    <button type="button" onclick="clickme(${i})" class="btn btn-primary">Add to cart</button>
                </div>
            </div>
        </div>
    `;
